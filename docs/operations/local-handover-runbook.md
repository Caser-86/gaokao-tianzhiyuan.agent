...
- `GAOKAO_AGENT_LLM_MAX_OUTPUT_TOKENS`
...
- `GAOKAO_AGENT_CHAT_MAX_MESSAGE_CHARS`
- `GAOKAO_AGENT_MODEL_MAX_CONCURRENCY`
- `GAOKAO_AGENT_CHAT_REQUEST_TIMEOUT_SECONDS`
- `GAOKAO_AGENT_CHAT_RATE_LIMIT_REQUESTS`
- `GAOKAO_AGENT_CHAT_RATE_LIMIT_WINDOW_SECONDS`
- `GAOKAO_AGENT_CHAT_DAILY_REQUEST_BUDGET`
- `GAOKAO_AGENT_LLM_MAX_RETRIES`
