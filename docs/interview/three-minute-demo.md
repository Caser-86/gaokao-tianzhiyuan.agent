...
| 2:25—2:45 | 展示 trace/eval 报告 | “我们用 30 个固定工程样本验证路由、结构化输出和 fallback，再用 40 条独立 replay 检查引用、无依据数字和追问覆盖；另有 1 条同问题同预算的 direct vs grounded 成对样本，逐项展示失败原因，而不是只展示一次成功对话。” | [`runner.py`](../../apps/api/app/evals/runner.py)、[`quality_runner.py`](../../apps/api/app/evals/quality_runner.py)、T09 评测报告 |
| 2:45—3:00 | 回到 README 的验证区 | “当前本地基线是 API 250 个测试通过、Web 131 个用例通过；真实模型成对质量、浏览器 E2E、Docker runtime 和生产发布仍明确列为待确认项。” | [`README.md`](../../README.md)、[`2026-09-15 T09 验证记录`](../verification/2026-09-15-t09-grounded-answers.md)、生产就绪矩阵 |
...
最新 T09 的证据注入、citation 校验和成对评测记录见 [`2026-09-15 T09 验证记录`](../verification/2026-09-15-t09-grounded-answers.md)；M1 的 Prompt 身份基线见 [`2026-09-15 M1 验证记录`](../verification/2026-09-15-m1-prompt-and-quality-evaluation.md)。
