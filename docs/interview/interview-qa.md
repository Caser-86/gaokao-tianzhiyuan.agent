...
当前本地验证为 API `241 passed`、Web `131 passed`；Prompt 快照、工程协议评测和
...
证据：[`README 测试区`](../../README.md)、[`2026-09-15 T08 验证记录`](../verification/2026-09-15-t08-controlled-multiturn.md)。
